...
online version: https://docs.dvolve.net/Posh-ACME.Deploy/v2/Functions/Set-RASSTPCertificate/
schema: 2.0.0
---
...
```powershell
Set-RASSTPCertificate [[-CertThumbprint] <String>] [[-PfxFile] <String>] [[-PfxPass] <SecureString>]
